...
def telemetry(sid, data):
    ...
    if data:
        ...
        if np.isfinite(Rover.vel):
            ...
            cv2.putText(Rover.vision_image, "Current FPS: {}".format(fps), (2, 15),
            ...
            if Rover.picking_up:
                ...
                mode = Rover.mode
            cv2.putText(Rover.vision_image, "Mode: {}          Speed: {}".format(mode, round(Rover.vel, 3)), (2, Rover.vision_image.shape[0] - 10),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
